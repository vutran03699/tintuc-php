<ul class="fashion_catgnav wow fadeInDown">
    <?php $rows = mysqli_fetch_array($rs_laptrinh) ;?>
                  <li>
                ...
                <?php while($rows = mysqli_fetch_array($rs_laptrinh))
                  { ?>
                <li>
                    <div class="media"> <a class="media-left" href="single.php?idTin=<?php echo($rows['idTin']);?>"><img src="./images/upload/tintuc/<?php echo($rows[4]);?>" alt=""></a>
